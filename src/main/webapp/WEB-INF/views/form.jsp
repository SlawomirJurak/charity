...
<section class="form--steps">
    ...
    <div class="form--steps-container">
        ...
        <form action="/donation/confirmation" method="post" id="donation-form">
            ...
            <div data-step="2">
                ...
                <div class="form-group form-group--inline">
                    <label>
                        Liczba 60l worków:
                        <input type="number" name="bags" step="1" min="1" max="25" />
                    </label>
                </div>
                ...
                <div class="form-section form-section--columns">
                    ...
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label>
                                Uwagi dla kuriera
                                <textarea name="more_info" rows="5" id="more-info"></textarea>
                            </label>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-section form-section--columns">
                        ...
                        <div class="form-section--column">
                            ...
                            <ul>
                                ...
                                <li id="summary-more-info">Brak uwag</li>
                            </ul>
                        </div>
                    </div>
                </div>
